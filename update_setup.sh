#!/bin/bash
# This script will update the setup section in index.html
                ...
                <div class="setup-container">\
                    ...
                    <div class="setting-group">\
                        ...
                        <div class="option-buttons">\
                            ...
                            <button class="option-btn" data-value="borosilicate">Borosilicate</button>\
                        </div>\
                    </div>\
                    \
                    ...
                    <div class="setting-group">\
                        ...
                        <div class="rig-type-buttons">\
                            ...
                            <button class="rig-type-btn" data-value="e_rig">\
                    ...
                    <div class="setting-group">\
                        ...
                        <div class="option-buttons">\
                            ...
                            <button class="option-btn" data-value="crumble">Crumble</button>\
                        </div>\
                    </div>\
                    \
                    <div class="setting-group">\
                        <h3>Custom Times (Seconds)</h3>\
                        <div class="custom-time-inputs">\
                            <div class="input-group">\
                                <label for="custom-heat">Heat Time:</label>\
                                <input type="number" id="custom-heat" min="10" max="180" value="30">\
                            </div>\
                            <div class="input-group">\
                                <label for="custom-cool">Cool Time:</label>\
